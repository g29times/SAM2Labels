...
# 测试方法
# print(json.loads(upload_image("E:/GoogleSync/6 AI/3 dataset/Picture/robot.jpg").text)['data']['url'])

# 原始代码
# url = "https://service-ijd4slqi-1253419200.gz.apigw.tencentcs.com/release/bili/upload"
# file_path = "robot.jpg"
